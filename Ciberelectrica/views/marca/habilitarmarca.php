...
<div class="container">
    ...
    <div class="mt-4">
        <h1>Habilitación de Marca</h1>
        <a href="/ciberelectrica/public/?controller=marca&action=listar" class="btn btn-dark">Regresar al Listado</a>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover table-bordered">
            ...
            <tbody>
                <?php if (isset($marca) && $marca->num_rows > 0): ?>
                    <?php while ($fila = $marca->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($fila['estmar'] == 0): ?>
                                    <a href="/ciberelectrica/public/?controller=marca&action=habilitar&id=<?= $fila['codmar']; ?>" class="btn btn-warning btn-sm">Habilitar</a>
                                <?php else: ?>
                            ...
                            <td>
                                <?php if ($fila['estmar'] == 1): ?>
                                    <a href="/ciberelectrica/public/?controller=marca&action=deshabilitar&id=<?= $fila['codmar']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Deseas deshabilitar este Marca?')">Deshabilitar</a>
                                <?php else: ?>
                                    <span class="text-muted">---</span>
                                <?php endif; ?>
                            </td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="text-center">No existen Marca registrados</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
