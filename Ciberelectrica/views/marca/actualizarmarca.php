...
<div class="container">
 ...
 <!-- inicio del menu -->
    ...
    <h1>Actualizacion de Marca</h1>
    <!-- inicio del formulario -->
    <form action="/ciberelectrica/public/?controller=marca&action=actualizar" method="post">
        <div class="col-6">
