...
<div class="container">
    ...
    <form action="/ciberelectrica/public/?controller=categoria&action=actualizar" method="post">
        <div class="col-6">
