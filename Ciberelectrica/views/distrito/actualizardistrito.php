...
<div class="container">
    ...
    <h1>Actualizacion de Distrito</h1>
    <!-- inicio del formulario -->
    <form action="/ciberelectrica/public/?controller=distrito&action=actualizar" method="post">
        <div class="col-6">
