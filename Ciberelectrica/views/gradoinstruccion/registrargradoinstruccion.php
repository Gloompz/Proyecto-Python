...
<head>
    ...
    <title>CiberElectrik | Registrar Grado de Instruccion</title>
...
<div class="container">
    ...
    <h1>Registro de Grado de Instruccion</h1>
    <!-- inicio del formulario -->
    <form action="/ciberelectrica/public/?controller=gradoinstruccion&action=registrar" method="post">
        <div class="col-6">
