...
<body>
    ...
    <div class="mt-4">
        ...
        <a href="/ciberelectrica/public/?controller=empleado&action=listar" class="btn btn-dark">Regresar al Listado</a>
    </div>
                    ...
                    <?php if ($empleados && $empleados->num_rows > 0): ?>
                        <?php while ($fila = $empleados->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/ciberelectrica/public/?controller=empleado&action=habilitar&id=<?= $fila['codemp']; ?>" class="btn btn-success">
                                        Habilitar
                                    </a>
                                </td>
                                <td>
                                    <a href="/ciberelectrica/public/?controller=empleado&action=deshabilitar&id=<?= $fila['codemp']; ?>" class="btn btn-danger" onclick="return confirm('¿Deseas eliminar este cliente?')">
                                        Deshabilitar
                                    </a>
                                </td>
                            </tr>
            ...
            <nav>
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item <?= ($pagina <= 1) ? 'disabled' : ''; ?>">
                        <a class="page-link bg-dark text-white border-dark" href="/ciberelectrica/public/?controller=empleado&action=habilita&page=<?= $pagina - 1; ?>">
                            Anterior
                        </a>
                    </li>
                    ...
                    <?php for ($i = 1; $i <= $totalPaginas; $i++): ?>
                        <li class="page-item <?= ($i == $pagina) ? 'active' : ''; ?>">
                            <a class="page-link <?= ($i == $pagina) ? 'bg-secondary text-white border-secondary' : 'bg-dark text-white border-dark'; ?>" href="/ciberelectrica/public/?controller=empleado&action=habilita&page=<?= $i; ?>">
                                <?= $i; ?>
                            </a>
                        </li>
                    <?php endfor; ?>
