    ...
    <div class="container mt-4 mb-5">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white py-3">
                <h1 class="h4 mb-0">Registro de Empleado</h1>
            </div>
            </div class="card-body p-4">
                <form action="/ciberelectrica/public/?controller=empleado&action=registrar" method="post">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-6">
                    ...
                    <input type="number" step="0.01" class="form-control" id="txtSue" name="txtSue"
                        placeholder="Ingrese el sueldo" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="mb-3 col-6">
                    ...
                    <input type="date" class="form-control" id="txtFeci" name="txtFeci" required>
                </div>
                <div class="mb-3 col-6">
