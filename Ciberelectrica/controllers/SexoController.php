...
class SexoController
{
    ...
    public function listar()
    {
        ...
        $sexo = $this->modelo->findAllCustomPaginated($inicio, $limite);
    ...
    public function registrar()
    {
        ...
        header('Location: /ciberelectrica/public/?controller=sexo&action=listar');
        exit;
    }
    ...
    public function habilita()
    {
        ...
        $totalPaginas = ceil($totalRegistros / $limite);
        $sexo = $this->modelo->findAllPaginated($inicio, $limite);
    ...
    public function habilitar()
    {
        ...
        header('Location: /ciberelectrica/public/?controller=sexo&action=habilita');
        exit;
    }
